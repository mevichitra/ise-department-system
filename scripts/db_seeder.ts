// db_seeder.ts - A script to populate the Neon database with dummy data
...
// Main function to handle database seeding
async function main() {
  console.log("ISE Department System - Database Seeder");
  console.log("======================================");
  
  // Get database connection string, either from .env or prompt user
  let dbUrl = process.env.DATABASE_URL;
  
  if (!dbUrl) {
    console.log("DATABASE_URL not found in environment variables.");
    dbUrl = await promptForInput("Please enter your Neon database connection string:");
    if (!dbUrl) {
